...
```{r domain , eval=TRUE, echo=FALSE, results='hide'}
# Follow 
...
![Combined bill (Water & WasteWater) /m3 conditional on the type of city](.././05_Output/01_PanelCoplotStatType.png)
</div>
...
![Water & WasteWater bills /m3 over time](.././05_Output/02_BoxplotTime.png)
</div>
